...
occ <- rbind(po1[,  c("decimalLongitude", "decimalLatitude", "scientificName")] %>% cbind(Taxa="Polychaeta"), 
             po2[,  c("decimalLongitude", "decimalLatitude", "scientificName")] %>% cbind(Taxa="Polychaeta"), 
             sh1[,  c("decimalLongitude", "decimalLatitude", "scientificName")] %>% cbind(Taxa="Alpheus Shrimp"), 
             sh2[,  c("decimalLongitude", "decimalLatitude", "scientificName")] %>% cbind(Taxa="Alpheus Shrimp"),
             fis
             )
...
| class      | classid | decimalLatitude |
|:-----------|--------:|----------------:|
| Polychaeta |     883 |         31.0000 |
| Polychaeta |     883 |         32.5000 |
| Polychaeta |     883 |         31.0000 |
| Polychaeta |     883 |         31.6625 |
| Polychaeta |     883 |         28.3917 |
| Polychaeta |     883 |         31.5000 |
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| -72.384 | 67.346 | 0.218 | 8.129 | 17.916 | 0 | 0 | 0.205 | 0.067 | 0.042 | 3.049 | 4.827 |
| -96.057 | 73.205 | 0.199 | 8.084 | 16.521 | 0 | 0 | 0.193 | 0.069 | 0.044 | 2.806 | 4.478 |
| -83.397 | 70.370 | 0.215 | 8.124 | 17.874 | 0 | 0 | 0.204 | 0.067 | 0.043 | 3.071 | 4.794 |
| -26.825 | 65.373 | 0.222 | 8.139 | 18.269 | 0 | 0 | 0.208 | 0.066 | 0.042 | 3.141 | 4.918 |
| -72.384 | 67.346 | 0.218 | 8.129 | 17.916 | 0 | 0 | 0.205 | 0.067 | 0.042 | 3.049 | 4.827 |
