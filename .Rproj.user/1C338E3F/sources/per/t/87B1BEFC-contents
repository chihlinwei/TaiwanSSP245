library(raster)
epc <- brick("G:/CMIP6_Taiwan/Raster/epcBottom/epcBottom_avg_ssp245.grd")
o2 <- brick("G:/CMIP6_Taiwan/Raster/o2Bottom/o2Bottom_avg_ssp245.grd")
ph <- brick("G:/CMIP6_Taiwan/Raster/phBottom/phBottom_avg_ssp245.grd")
thetao <- brick("G:/CMIP6_Taiwan/Raster/thetaoBottom/thetaoBottom_avg_ssp245.grd")
arag <- brick("G:/CMIP6_Taiwan/Raster/aragBottom/aragBottom_avg_ssp245.grd")
calc <- brick("G:/CMIP6_Taiwan/Raster/calcBottom/calcBottom_avg_ssp245.grd")
co3 <- brick("G:/CMIP6_Taiwan/Raster/co3Bottom/co3Bottom_avg_ssp245.grd")
co3satarag <- brick("G:/CMIP6_Taiwan/Raster/co3sataragBottom/co3sataragBottom_avg_ssp245.grd")
co3satcalc <- brick("G:/CMIP6_Taiwan/Raster/co3satcalcBottom/co3satcalcBottom_avg_ssp245.grd")
aragsat <- brick("G:/CMIP6_Taiwan/Raster/aragsatBottom/aragsatBottom_avg_ssp245.grd")
calcsat <- brick("G:/CMIP6_Taiwan/Raster/calcsatBottom/calcsatBottom_avg_ssp245.grd")
